...
(
    ...
    FOREIGN KEY (BRANCH_CODE) REFERENCES BANK_SYSTEM.BRANCH(BRANCH_CODE)
);

CREATE TABLE IF NOT EXISTS TRANSACTION
(
	TRANSACT_NUM CHAR(9) NOT NULL PRIMARY KEY,
    TRANSACT_TYPE VARCHAR(12) NOT NULL,
    TRANSACT_AMMOUNT DECIMAL(9, 2) NOT NULL,
    EMP_ID CHAR(5),
    CL_ID CHAR(5) NOT NULL,
    ACC_ID CHAR(8) NOT NULL,
    FOREIGN KEY (EMP_ID) REFERENCES BANK_SYSTEM.EMPLOYEE(EMP_ID),
    FOREIGN KEY (CL_ID) REFERENCES BANK_SYSTEM.CLIENT(CL_ID),
    FOREIGN KEY (ACC_ID) REFERENCES BANK_SYSTEM.ACCOUNT(ACC_ID)
);

CREATE TABLE IF NOT EXISTS CLIENT
(
	CL_ID CHAR(5) NOT NULL PRIMARY KEY,
...
(
	ACC_ID CHAR(8) NOT NULL PRIMARY KEY,
...
(
    ...
    FOREIGN KEY (ACC_ID) REFERENCES BANK_SYSTEM.ACCOUT(ACC_ID)
);
